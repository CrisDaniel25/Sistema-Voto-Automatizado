    ...
    <div class="row">
        ...
        <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
            ...
            <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
                ...
                <div class="card-footer bg-transparent border-light">
                    <center><a href="SeleccionSenador.php?id=<?php echo $row['candidatoid']?>" id="bt" class="btn btn-info"><b>Seleccionar</b></a><center>
                </div>
            </div>    
                        <?php endif;?>
                    <?php endif?>
...
<div>
        <form method="POST" action="SeleccionSenador.php?id=<?php echo $_GET['id']?>">
